...
Processes polarimetric image sets (I₀, I₄₅, I₉₀, I₁₃₅) and outputs depth maps, magma visualizations, and recovered images. Configure the image range with `START_NUM` and `END_NUM` in the script.
